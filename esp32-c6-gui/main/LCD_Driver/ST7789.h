...
// Native panel size is 172x320. Use landscape as the active UI orientation.
#define EXAMPLE_LCD_H_RES              172
#define EXAMPLE_LCD_V_RES              320
#define EXAMPLE_LCD_UI_H_RES           EXAMPLE_LCD_V_RES
#define EXAMPLE_LCD_UI_V_RES           EXAMPLE_LCD_H_RES
// Bit number used to represent command and parameter
#define EXAMPLE_LCD_CMD_BITS           8
#define EXAMPLE_LCD_PARAM_BITS         8

#define EXAMPLE_LCD_GAP_X              0
#define EXAMPLE_LCD_GAP_Y              34
