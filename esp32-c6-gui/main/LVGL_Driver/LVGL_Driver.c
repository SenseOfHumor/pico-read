...
void LVGL_Init(void)
{
    ...
    disp_drv.hor_res = EXAMPLE_LCD_UI_H_RES;
    disp_drv.ver_res = EXAMPLE_LCD_UI_V_RES;
    // Keep the panel in its native orientation. Rotating here caused rendering issues.
